            ...
            <div className="pricing_menu mt-8 pb-8">
              <ul className="flex justify-center">
                <li className="nav-item">
                  <button className="active bg-gray text-body-color py-3 px-8 rounded-tl-full rounded-bl-full" data-tab-target="#monthlyPlan">
                    Monthly
                  </button>
                </li>
                <li className="nav-item">
                  <button className="bg-gray text-body-color py-3 px-8 rounded-tr-full rounded-br-full" data-tab-target="#yearlyPlan">
                    Yearly
                  </button>
                </li>
              </ul>
